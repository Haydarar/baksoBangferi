...
function openPopup(button) {
    ...
    // popupImage.src = `./images/${productId}.jpg`;
    popupImage.src = `./images/menu1.jpg`;
...
function updateCartUI() {
    ...
    if (cartItems.length === 0) {
        cartItemsContainer.innerHTML = '<p class="empty-cart">Keranjang Kosong, Yuk pilih mau makan apa hari ini!</p><br>';
